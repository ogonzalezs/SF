namespace AT.Middleware.Service.Authorization
{
    ...
    public class ClientAuthorization : ServiceAuthorizationManager, IDisposable
    {
        private static readonly ILog log =
                LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public static Client oClient = null;
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        ...
        protected override bool CheckAccessCore(OperationContext operationContext)
        {
            ...
            if ((authHeader != null) && (authHeader != string.Empty))
            {
                ...
                try
                {
                    if(oClient== null)
                    {
                        oClient = new Client(Properties.Settings.Default.Server,
